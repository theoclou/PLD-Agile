...
const MapComponent = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="buttonContainer">
        <button className="button" disabled={!mapLoaded}>
          Load Delivery
        </button>
        <input
          type="file"
      ...
      <div className="buttonContainer">
        ...
        <span className="courierCounter">Couriers: {numberCouriers}</span>
        ...
        >
          ...
          {data.sections.map((section, index) => {
            ...
            if (originIntersection && destinationIntersection) {
              ...
              return (
                <Polyline key={index} positions={latLngs} color="red" weight={2} opacity={1} />
              );
            }
            return null;
          })}
